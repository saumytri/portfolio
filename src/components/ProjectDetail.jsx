...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#110000] rounded-xl overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-br from-red-900/20 to-rose-900/20 opacity-50 blur-2xl z-0" />

      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-white/10 transition-all duration-300 hover:scale-105 hover:border-red-500/50 hover:shadow-lg">
        <div className="bg-red-500/20 p-1.5 md:p-2 rounded-full">
          <Code2 className="text-red-300 w-4 h-4 md:w-6 md:h-6" strokeWidth={1.5} />
        </div>
        <div className="flex-grow">
          <div className="text-lg md:text-xl font-semibold text-red-200">{techStackCount}</div>
          <div className="text-[10px] md:text-xs text-gray-300">Total Teknologi</div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-rose-500/20 transition-all duration-300 hover:scale-105 hover:border-rose-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-gray-300">Fitur Utama</div>
        </div>
      </div>
    </div>
  );
...
const ProjectDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0000] px-[2%] sm:px-0 relative overflow-hidden">
      {/* Background animations remain unchanged */}
      <div className="fixed inset-0">
        <div className="absolute -inset-[10px] opacity-20">
          <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-rose-500 rounded-full mix-blend-screen filter blur-3xl opacity-70 animate-blob" />
          <div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-red-500 rounded-full mix-blend-screen filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
          <div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-pink-500 rounded-full mix-blend-screen filter blur-3xl opacity-70 animate-blob animation-delay-4000" />
        </div>
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            <button
              onClick={() => navigate(-1)}
              className="group inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-5 py-2 md:py-2.5 bg-white/5 backdrop-blur-xl rounded-xl text-white/90 hover:bg-white/5 transition-all duration-300 border border-white/10 hover:border-white/20 text-sm md:text-base"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-red-600/10 to-rose-600/10 hover:from-red-600/20 hover:to-rose-600/20 text-red-300 rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                >
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-gray-300 opacity-50">No technologies added.</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0000] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <img
                  src={project.Img}
                  alt={project.Title}
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                ...
                {project.Features.length > 0 ? (
                  ...
                  <p className="text-gray-300 opacity-50">No features added.</p>
                )}
              </div>
            </div>
          </div>
