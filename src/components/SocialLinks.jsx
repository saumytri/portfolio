          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold pt-[0.2rem] text-gray-100 tracking-tight leading-none group-hover:text-white transition-colors duration-300">
                  {link.displayName}
                </span>
            ...
            <ExternalLink
              className="relative w-5 h-5 text-gray-400 group-hover:text-white
