...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    ...
    <div className="absolute inset-0 bg-gradient-to-tr from-red-600/10 via-transparent to-orange-600/10 blur-2xl animate-float" />
  </div>
);
...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  return (
    <AnimatePresence>
      {isLoading && (
        <motion.div
          className="fixed inset-0 bg-[#050000]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit="exit"
                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span
                      data-aos="fade-right"
                      data-aos-delay="200"
                      className="inline-block px-2 bg-gradient-to-r from-white via-red-300 to-red-500 bg-clip-text text-transparent"
                    >
                      Welcome
                    </span>{" "}
                    <span
                  ...
                  <div>
                    <span
                      data-aos="fade-up"
                      data-aos-delay="800"
                      className="inline-block px-2 bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent"
                    >
                      Portfolio
                    </span>{" "}
                    <span
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group">
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent font-semibold">
